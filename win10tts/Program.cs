...
namespace win10tts
{
    public class MsTTSBuilder : PromptBuilder
    {
        public MsTTSBuilder()
            : base()
        {
        ...
        public MsTTSBuilder(CultureInfo culture)
            : base(culture)
        {

        }
        public void Add_As_Normal_Text(string textToAdd)
        {
            base.AppendText(textToAdd);
        }
        public void Add_As_Fast_Text(string textToAdd)
        {
            base.AppendText(textToAdd, PromptRate.Fast);
        }
        public void Add_As_Slow_Text(string textToAdd)
        {
            base.AppendText(textToAdd, PromptRate.Slow);
        }
        public void Add_As_SoundLoud_Text(string textToAdd)
        {
            base.AppendText(textToAdd, PromptVolume.Loud);
        }
        public void Add_As_SoundMedium_Text(string textToAdd)
        {
            base.AppendText(textToAdd, PromptVolume.Medium);
        }
        public void Add_As_SoundSoft_Text(string textToAdd)
        {
            base.AppendText(textToAdd, PromptVolume.Soft);
        }
        /// <summary>
        ...
        public void Add_As_SpellOut_Text(string textToAdd)
        {
            base.AppendTextWithHint(textToAdd, System.Speech.Synthesis.SayAs.SpellOut);
        }
        /// <summary>
        ...
        /// <param name="builder"></param>
        /// <param name="textToAdd"></param>
        public void Add_As_Number_Text(string textToAdd)
        {
            base.AppendTextWithHint(textToAdd, System.Speech.Synthesis.SayAs.NumberCardinal);
        }
        /// <summary>
        ...
        /// <param name="builder"></param>
        /// <param name="textToAdd"></param>
        public void Add_As_Telephone_Text(string textToAdd)
        {
            base.AppendTextWithHint(textToAdd, System.Speech.Synthesis.SayAs.Telephone);
        }
        /// <summary>
        ...
        /// <param name="textToAdd"></param>
        /// <returns></returns>
        public bool Add_As_DateTime_Text(string textToAdd)
        {
            DateTime dt;
            ...
            base.AppendTextWithHint(sDate, System.Speech.Synthesis.SayAs.YearMonthDay);
            base.AppendTextWithHint(sTime, System.Speech.Synthesis.SayAs.Time24);
            return true;
        }
        /// <summary>
        /// 仅有日期部分
        ...
        /// <param name="textToAdd"></param>
        /// <returns></returns>
        public bool Add_As_Date_Text(string textToAdd)
        {
            DateTime dt;
            if (!DateTime.TryParse(textToAdd, out dt))
                return false;
            base.AppendTextWithHint(dt.ToString("yyyy-M-d"), System.Speech.Synthesis.SayAs.YearMonthDay);
            return true;
        }
        /// <summary>
        ...
        /// <param name="builder"></param>
        /// <param name="textToAdd"></param>
        public void Add_As_Time_Text(string textToAdd)
        {
            base.AppendTextWithHint(textToAdd, System.Speech.Synthesis.SayAs.Time);
        }
        /// <summary>
        ...
        /// <param name="builder"></param>
        /// <param name="textToAdd"></param>
        public void Add_As_Time12_Text(string textToAdd)
        {
            base.AppendTextWithHint(textToAdd, System.Speech.Synthesis.SayAs.Time12);
        }
        /// <summary>
        /// 24小时时间表示法。例如 13:35
        /// </summary>
        /// <param name="builder"></param>
        /// <param name="textToAdd"></param>
        public void Add_As_Time24_Text(string textToAdd)
        {
            base.AppendTextWithHint(textToAdd, System.Speech.Synthesis.SayAs.Time24);
        }

        public void Add_wav(string filePath)
        {
            base.AppendAudio(filePath);
        }
        public bool Add_mp3(string filePath)
        {
            return true;
        }
        public bool Add_wma(string filePath)
        {
            return true;
        }
        public bool Add_aac(string filePath)
        {
            return true;
        }
        public void Add_Audio(string audioFilePath)
        {
            base.AppendAudio(audioFilePath);
        }
        public void Add_Audio(Uri audioFile)
        {
            base.AppendAudio(audioFile);
        }
        public void Add_Audio(Uri audioFile, string alternateText)
        {
            base.AppendAudio(audioFile, alternateText);
        }
    }
